...
previous_nodes, shortest_path = dijkstra_algorithm(graph=graph, start_node="Neamt")
print_result(previous_nodes, shortest_path, start_node="Neamt", target_node="Oradea")